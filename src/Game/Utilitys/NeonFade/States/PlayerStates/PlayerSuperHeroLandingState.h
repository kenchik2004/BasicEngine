...
namespace NeonFade {
	...
	private:
		...
		static constexpr float LANDING_DURATION = 0.5f; // 着地アニメーションの持続時間
		...
		static inline const Vector3 CAMERA_SHAKE_INTENSITY = { 0.5f, 2.5f, 0.5f }; // カメラの揺れの強さ
		static constexpr float CAMERA_SHAKE_DURATION = 0.7f; // カメラの揺れの持続時間

		static constexpr float KNOCKBACK_UPWARD_FORCE = 1.0f; // ノックバックの上方向の力の大きさ
		static constexpr float KNOCKBACK_FORCE = 50.0f; // ノックバックの力の大きさ
