...
namespace NetWorkTest {
	...
	SafeWeakPtr<Sample::SampleAnimationObject> player = nullptr;
	std::vector<std::pair<u32, SafeWeakPtr<Sample::SampleAnimationObject>>> another_players;
	...
	static inline void UpsertPlayer(std::vector<std::pair<u32, SafeWeakPtr<Sample::SampleAnimationObject>>>& list, IPDATA ip, const PlayerData& data) {
